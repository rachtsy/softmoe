...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, attn_drop=0., proj_drop=0., layerth=0, ttl_tokens=0):
        ...
        # self.s = nn.Linear(dim, self.ttl_tokens*self.num_heads, bias=True)
    ...
    def forward(self, x):
        ...
        # s = sym_attn * (1/sym_attn.transpose(-2,-1))
        # s = s.detach()
        # print(s.shape)
        ...
        # s = self.s(x).reshape(B,self.num_heads,N,N)
