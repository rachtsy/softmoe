...
def build_dataset(is_train, args):
    ...
    if args.data_set == 'CIFAR10':
        ...
        # i think something weird happens when you copy the images...
        root = os.path.join(args.data_path, 'train' if is_train else 'Small_ImageNet_Val/ILSVRC2012_img_val_subset')
        # Small_ImageNet_Val/ILSVRC2012_img_val_subset
    ...
    return dataset, nb_classes, class_names
