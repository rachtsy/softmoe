...
from timm.models.vision_transformer import get_init_weights_vit, _load_weights
...
class VisionTransformer(nn.Module):
    ...
    def init_weights(self, mode=''):
        ...
        if mode.startswith('jax'):
            ...
            named_apply(partial(get_init_weights_vit(mode, head_bias), head_bias=head_bias, jax_impl=True), self)
        else:
